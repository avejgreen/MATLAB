...
function varargout = FlakeStackFresnelContrast(varargin)
%FLAKESTACKFRESNELCONTRAST M-file for FlakeStackFresnelContrast.fig
%      FLAKESTACKFRESNELCONTRAST, by itself, creates a new FLAKESTACKFRESNELCONTRAST or raises the existing
%      singleton*.
%
%      H = FLAKESTACKFRESNELCONTRAST returns the handle to a new FLAKESTACKFRESNELCONTRAST or the handle to
%      the existing singleton*.
%
%      FLAKESTACKFRESNELCONTRAST('Property','Value',...) creates a new FLAKESTACKFRESNELCONTRAST using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to FlakeStackFresnelContrast_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      FLAKESTACKFRESNELCONTRAST('CALLBACK') and FLAKESTACKFRESNELCONTRAST('CALLBACK',hObject,...) call the
%      local function named CALLBACK in FLAKESTACKFRESNELCONTRAST.M with the given input
%      arguments.
%
...
% Edit the above text to modify the response to help FlakeStackFresnelContrast

% Last Modified by GUIDE v2.5 18-Dec-2013 12:27:27

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @FlakeStackFresnelContrast_OpeningFcn, ...
                   'gui_OutputFcn',  @FlakeStackFresnelContrast_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before FlakeStackFresnelContrast is made visible.
function FlakeStackFresnelContrast_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line output for FlakeStackFresnelContrast
...
% UIWAIT makes FlakeStackFresnelContrast wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = FlakeStackFresnelContrast_OutputFcn(hObject, eventdata, handles)
