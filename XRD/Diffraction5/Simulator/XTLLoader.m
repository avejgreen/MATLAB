function [error,Name,a,b,S,Atoms] = XTLLoader(LayerNum)
...
if LayerNum == 1
    [FileName,PathName] = uigetfile('/Users/averygreen/Desktop/VESTA/Files xtl/*.xtl','Select .xtl file for substrate');
else
    [FileName,PathName] = uigetfile('/Users/averygreen/Desktop/VESTA/Files xtl/*.xtl',horzcat('Select .xtl file for epi layer ',int2str(LayerNum)));
end
